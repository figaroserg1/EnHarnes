...
## Структура проекта
- `README.md`, `QUICKSTART.md`, `METHOD.md` — стартовые документы фазы.
- `ARCHITECTURE.md` — high-level карта репозитория.
- `docs/design-docs/` — системная спецификация, правила и архитектурные решения.
- `docs/exec-plans/` — активные/завершённые планы и трекер техдолга.
- `docs/references/` — внешние материалы и справки.
- `scripts/` — проверочные и операционные команды.
- `tools/` — инфраструктурные утилиты для контроля качества.

## Где что искать
- Общий контекст: `README.md`, `ARCHITECTURE.md`, `METHOD.md`.
- Правила разработки и агента: `docs/design-docs/rules.md`.
- Планирование работ: `docs/PLANS.md`, `docs/exec-plans/`.
- Надёжность/безопасность/наблюдаемость: `docs/RELIABILITY.md`, `docs/SECURITY.md`, `docs/OBSERVABILITY.md`.
...
- How to use a skill (progressive disclosure):
  ...
  4) If `assets/` or reusable artifacts exist, reuse them instead of recreating from scratch.
